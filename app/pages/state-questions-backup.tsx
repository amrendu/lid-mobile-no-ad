    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.appBar}>
        <View style={styles.appBarContent}>
          ...
          <View style={styles.titleContainer}>
            ...
            <Text style={styles.counterText}>
              {stateQuestions.length > 0 ? `Q${currentQuestionIndex + 1}/${stateQuestions.length} • ${selectedState}` : `${selectedState || 'Select a state'}`}
            </Text>
          </View>
          <View style={styles.rightActions}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => setShowQuestionOverview(false)}
              activeOpacity={0.7}
            >
              <Text style={styles.stateButtonText}>📍</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.compactSelectorContainer}>
          <Text style={styles.selectorLabel}>Select Bundesland:</Text>
        ...
        {stateQuestions.length === 0 ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyTitle}>
              {selectedState ? 'No Questions Available' : 'Select a State'}
            </Text>
            <Text style={styles.emptyDesc}>
              {selectedState 
                ? `No questions found for ${selectedState}. Try selecting a different state.`
                : 'Please select a Bundesland from the dropdown above to view questions.'
              }
            </Text>
          </View>
        ) : !showQuestionOverview ? (
          ...
          <View style={styles.overviewContainer}>
            <ScrollView 
              ...
              showsVerticalScrollIndicator={false}
            >
              <Text style={styles.overviewTitle}>{selectedState} Questions</Text>
      ...
      {stateQuestions.length > 0 && !showQuestionOverview && (
        <View style={styles.navigationControls}>
          ...
          <TouchableOpacity 
            style={[styles.navButton, currentQuestionIndex === stateQuestions.length - 1 && styles.disabledButton]}
            onPress={goToNextQuestion}
            disabled={currentQuestionIndex === stateQuestions.length - 1}
            activeOpacity={0.7}
          >
            <Text style={[styles.navButtonText, currentQuestionIndex === stateQuestions.length - 1 && styles.disabledButtonText]}>
              Next →
            </Text>
          </TouchableOpacity>
        </View>
